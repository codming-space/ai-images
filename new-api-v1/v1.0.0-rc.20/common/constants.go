...
// SetTheme is intentionally locked: frontend theme switching is disabled, so the
// served theme is always "default" regardless of the requested value (including any
// value saved into the "theme" option by an admin).
